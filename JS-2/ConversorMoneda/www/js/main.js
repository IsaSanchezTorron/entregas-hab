...
//Selecciono en el DOM tanto los selectores como su contenido.
...
function calcular() {
  ...
  fetch(`https://api.exchangerate-api.com/v4/latest/${cantidad_uno}`)
    ...
    .then(data => {
      ...
      // pongo en el  visor la cantidad correspondiente
...
// cambios en los inputs para poder calcular todo
// en tiempo real.
